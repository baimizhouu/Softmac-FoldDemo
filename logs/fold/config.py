...
_C.SHAPES = [
    {
        "shape": "predefined",
        "offset": (0., 0.1, 0.),
        "path": Path("envs/fold/folded_dough.npy"),
...
Gripper.urdf_path = "assets/allegro_touch_sensor/allegro_touch_sensor.urdf"
...
# ---------------------------------------------------------------------------- #
_C.ENV = ENV = CN()
ENV.loss_type = "FoldLoss"
loss = ENV.loss = CN()
loss.weight = (1., 0., 0.)  # chamfer, pose, velocity
loss.target_path = './envs/fold/folded_dough.npy'
